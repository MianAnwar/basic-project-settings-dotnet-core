...
namespace Application.xUnit.Tests.Mocks
{
    public class RepositoryMocks
    {
        public static Mock<IAsyncRepository<Category>> GetCategoryRepository()
        {
            ...
            //Actual thing is \/
            //setting up <Setup> the IAsyncRepository Functions, what they ReturnAsync'ly...
            var mockCategoryRepository = new Mock<IAsyncRepository<Category>>();
            
            mockCategoryRepository.Setup(
                                    repo => repo.ListAllAsync()
